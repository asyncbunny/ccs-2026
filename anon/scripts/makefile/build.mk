...
build-help:
	...
	@echo "  build-linux          Build anond linux version binary"
	@echo "  build-testnet       Build anond testnet version binary"
	@echo "  build-mocks         Build anond mocks"
...
build: BUILD_ARGS=-o $(BUILDDIR)/ ## Build anond binary
build-linux: ## Build anond linux version binary
...
build-testnet:
	ANON_BUILD_OPTIONS=testnet make build
