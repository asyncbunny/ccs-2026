...
var (
	// https://anon-testnet-api.nodes.guru/anon/btcstaking/v1/btc_delegation/56d54aa3f925a86f51da8c791ab7251ed4a62ac0ec187ac50f5e50363039b880

	btcDelegationJSON = `
	{
    "staker_addr": "anc1h4d84m77wtuklrv8jgryv5e748ke6mz5k530uk",
	...
	// https://anon-testnet-api.nodes.guru/anon/btcstaking/v1/params
	paramsJSON = `
	{
    "covenant_pks": [
...
func TestOldFormatCompat(t *testing.T) {
	...
	stakingMsgTx, _, err := anc.NewBTCTxFromHex(btcDel.StakingTxHex)
	require.NoError(t, err)
	fundingOut := stakingMsgTx.TxOut[btcDel.StakingOutputIdx]

	slashingMsgTx, _, err := anc.NewBTCTxFromHex(btcDel.SlashingTxHex)
	require.NoError(t, err)
