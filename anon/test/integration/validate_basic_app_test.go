...
func TestValidateBasic_AppIntegration(t *testing.T) {
	...
	t.Run("MsgInsertHeaders_CheckTx_ValidateBasic_Flow", func(t *testing.T) {
		t.Run("ValidTransaction_ShouldPassValidateBasic", func(t *testing.T) {
			...
			msg := &btclightclienttypes.MsgInsertHeaders{
				...
				Headers: []anc.BTCHeaderBytes{anc.NewBTCHeaderBytesFromBlockHeader(chainExtension[0])},
			}
			...
			fee := sdk.NewCoins(sdk.NewCoin("uanc", math.NewInt(1000)))
		...
		t.Run("InvalidTransaction_EmptyHeaders_ValidateBasic_Fails", func(t *testing.T) {
			...
			msg := &btclightclienttypes.MsgInsertHeaders{
				Signer:  signerAddr.String(),
				Headers: []anc.BTCHeaderBytes{}, // Empty headers - specific ValidateBasic validation
			}
	...
	t.Run("MsgCommitPubRandList_CheckTx_ValidateBasic_Flow", func(t *testing.T) {
		t.Run("ValidTransaction_ShouldPassValidateBasic", func(t *testing.T) {
			...
			sig, err := anc.NewBIP340SignatureFromHex("0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef")
			require.NoError(t, err)
	...
	t.Run("MsgAddFinalitySig_CheckTx_ValidateBasic_Flow", func(t *testing.T) {
		t.Run("ValidTransaction_ShouldPassValidateBasic", func(t *testing.T) {
			...
			pubRand, err := anc.NewSchnorrPubRandFromHex("0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef")
			require.NoError(t, err)
	...
	t.Run("TransactionLevelValidation_CheckTx_Flow", func(t *testing.T) {
		...
		invalidMsg := &btclightclienttypes.MsgInsertHeaders{
			Signer:  signerAddr.String(),
			Headers: []anc.BTCHeaderBytes{}, // Empty headers - ValidateBasic check
		}
...
func signTransactionWithSecp256k1(t *testing.T, helper *testhelper.Helper, app *app.AnonApp, txBuilder client.TxBuilder, accountPrivKey *secp256k1.PrivKey) []byte {
	signerAddr := sdk.AccAddress(accountPrivKey.PubKey().Address())
