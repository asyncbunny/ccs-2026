...
const (
	...
	// name of anon image produced by running `make build-docker`
	AnonContainerName = "anon-org/anond"
	// name of anon image before the upgrade
	AnonContainerNameBeforeUpgrade = "anon/anond"
	AnonContainerTagBeforeUpgrade  = "v4.2.2-testnet"
...
func NewContainerAncNode(containerName string) *Container {
	return &Container{
		Name:       containerName,
		Repository: AnonContainerName,
		Tag:        "latest",
	}
}

// NewContainerOldAncNode create an older binary version of a anc node which is used before upgrade
func NewContainerOldAncNode(containerName, tag string) *Container {
	cTag := AnonContainerTagBeforeUpgrade
	if tag != "" {
		cTag = tag
	}
	...
	return &Container{
		Name:       containerName,
		Repository: AnonContainerNameBeforeUpgrade,
		Tag:        cTag,
	}
}
