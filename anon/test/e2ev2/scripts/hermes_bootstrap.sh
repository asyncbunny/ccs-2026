...
rpc_addr = 'http://$ANC_A_E2E_VAL_HOST_RPC'
grpc_addr = 'http://$ANC_A_E2E_VAL_HOST_GRPC'
event_source = { mode = 'push', url = 'ws://$ANC_A_E2E_VAL_HOST_RPC/websocket', batch_delay = '500ms' }
rpc_timeout = '10s'
account_prefix = 'anc'
...
rpc_addr = 'http://$ANC_B_E2E_VAL_HOST_RPC'
grpc_addr = 'http://$ANC_B_E2E_VAL_HOST_GRPC'
event_source = { mode = 'push', url = 'ws://$ANC_B_E2E_VAL_HOST_RPC/websocket', batch_delay = '500ms' }
rpc_timeout = '10s'
account_prefix = 'anc'
