...
func (d *AnonAppDriver) TxWrappedDelegate(delegator *SenderInfo, valAddr string, amount sdkmath.Int) {
...
func (d *AnonAppDriver) TxCreateValidator(operator *SenderInfo, amount sdkmath.Int) {
...
func (d *AnonAppDriver) TxWrappedUndelegate(delegator *SenderInfo, valAddr string, amount sdkmath.Int) {
...
func (d *AnonAppDriver) TxWrappedBeginRedelegate(delegator *SenderInfo, valSrcAddr, valDstAddr string, amount sdkmath.Int) {
...
func (d *AnonAppDriver) StakingUpdateParams(maxValidators uint32) {
