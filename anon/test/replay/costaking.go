...
func (d *AnonAppDriver) ZeroCostakerRewards(addr sdk.AccAddress) {
	costkK := d.App.CostakingKeeper
...
func (d *AnonAppDriver) CheckCostakingCurrentRewards(
...
func (d *AnonAppDriver) CheckCostakingCurrentHistoricalRewards(
	period uint64,
...
func (d *AnonAppDriver) GenerateNewBlockAssertExecutionSuccessWithCostakerRewards() sdk.Coins {
...
func (d *AnonAppDriver) AreValsInActiveSet(expLenValset int, valAddrs ...sdk.ValAddress) epochingtypes.ValidatorSet {
	return d.CheckValsForCurrValset(expLenValset, true, valAddrs...)
}

func (d *AnonAppDriver) AreValsInactive(expLenValset int, valAddrs ...sdk.ValAddress) epochingtypes.ValidatorSet {
	return d.CheckValsForCurrValset(expLenValset, false, valAddrs...)
}

func (d *AnonAppDriver) CheckValsForCurrValset(expLenValset int, valsInValset bool, valAddrs ...sdk.ValAddress) epochingtypes.ValidatorSet {
...
func (d *AnonAppDriver) JailValidatorForDowntime(val sdk.ValAddress) *stktypes.Validator {
