...
func (d *AnonAppDriver) BankBalances(addrs ...sdk.AccAddress) map[string]sdk.Coins {
...
func (d *AnonAppDriver) BankBalance(denom string, addrs ...sdk.AccAddress) map[string]sdk.Coin {
	bankK := d.App.BankKeeper
...
func (d *AnonAppDriver) BankBalanceBond(addrs ...sdk.AccAddress) map[string]sdk.Coin {
