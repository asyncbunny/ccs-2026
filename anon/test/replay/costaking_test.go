...
func TestCostakingValidatorDirectRewards(t *testing.T) {
	...
	existingFees := sdk.NewCoins(sdk.NewCoin("uanc", sdkmath.NewInt(50000000))) // 50 ANC
...
func TestCostakingRewardsHappyCase(t *testing.T) {
	...
	// del1 (400000sats, 20_000000uanc) = 400000score
	// del2 (300000sats, 20_000000uanc) = 300000score
	// del3 (300000sats, 10_000000uanc) = 200000score
...
func TestCostakingFpSlashedAndBtcUnbondSameBlockPreventsDoubleSatsRemoval(t *testing.T) {
	...
	// In the same anon block and check if the sats were not removed twice
...
func TestMainnetInflationDistributionAmount(t *testing.T) {
	...
	// example with 100 uanc to be distributed
	// 1. incentives 2. costaking 3. distribution

	// (1 / 5.5) ≈ 0.181818182 of total inflation goes to btc stakers
	// percentageBtcStakers * 100 uanc ≈ 18.181818 uanc

	// (0.075 / 5.5) ≈ 0.013636364 of total inflation goes to fp directly
	// percentageFpDirect * 100 uanc ≈ 1.3636364 uanc

	// 2. costaking
	// 100 uanc - (btc stakers + fp direct) ≈ 81.4545456 uanc
