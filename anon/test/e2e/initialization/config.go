...
import (
	...
	e2ev2 "github.com/anon-org/anon/v4/test/e2ev2/tmanager"
...
const (
	...
	// chainA
	ChainAID        = "anc-test-a"
	AnonBalanceA = 3000000000000
	StakeAmountA    = 100000000000
	// chainB
	ChainBID        = "anc-test-b"
	AnonBalanceB = 5000000000000
	StakeAmountB    = 400000000000
)

var (
	StakeAmountIntA  = sdkmath.NewInt(StakeAmountA)
	StakeAmountCoinA = sdk.NewCoin(AnonDenom, StakeAmountIntA)
	StakeAmountIntB  = sdkmath.NewInt(StakeAmountB)
	StakeAmountCoinB = sdk.NewCoin(AnonDenom, StakeAmountIntB)
	InitBalanceStrA  = fmt.Sprintf("%d%s", AnonBalanceA, AnonDenom)
	InitBalanceStrB  = fmt.Sprintf("%d%s", AnonBalanceB, AnonDenom)
)
