...
func (n *internalNode) createAppConfig(nodeConfig *NodeConfig) {
	...
	appConfig.MinGasPrices = fmt.Sprintf("%s%s", MinGasPrice, AnonDenom)
...
func (n *internalNode) init(gasLimit int64) error {
	...
	appGenesis.Consensus.Params.ABCI.VoteExtensionsEnableHeight = anonApp.DefaultVoteExtensionsEnableHeight
