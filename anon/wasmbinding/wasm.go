...
import (
	...
	lcKeeper "github.com/anon-org/anon/v4/x/btclightclient/keeper"
...
func CustomQuerier(qp *QueryPlugin) func(ctx sdk.Context, request json.RawMessage) ([]byte, error) {
	return func(ctx sdk.Context, request json.RawMessage) ([]byte, error) {
		var contractQuery bindings.AnonQuery
		...
		case contractQuery.BtcHeaderByHash != nil:
			headerHash, err := anc.NewBTCHeaderHashBytesFromHex(contractQuery.BtcHeaderByHash.Hash)
		...
		case contractQuery.BtcHeaderByHeight != nil:
			...
			return bz, nil
		default:
			return nil, wasmvmtypes.UnsupportedRequest{Kind: "unknown anon query variant"}
		}
	}
}
