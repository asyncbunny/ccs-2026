...
import (
	...
	btcstkhelper "github.com/anon-org/anon/v4/testutil/btcstaking-helper"
	...
	"github.com/anon-org/anon/v4/x/incentive/keeper"
...
func NewIncentiveHelper(
	...
	btcstkH := btcstkhelper.NewHelperWithStoreAndIncentive(t, db, stateStore, btclcKeeper, btccKForBtcStaking, btccKForFinality, ictvK, nil, ictvK.Hooks())
