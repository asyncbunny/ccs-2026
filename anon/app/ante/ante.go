...
import (
	...
	btcckeeper "github.com/anon-org/anon/v4/x/btccheckpoint/keeper"
...
// NewAnteHandler creates a new AnteHandler for the Anon chain.
func NewAnteHandler(
	...
	// - Extra decorators introduced in Anon, such as DropValidatorMsgDecorator that delays validator-related messages
	//
