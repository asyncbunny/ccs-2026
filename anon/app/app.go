...
import (
	...
	appkeepers "github.com/anon-org/anon/v4/app/keepers"
	appparams "github.com/anon-org/anon/v4/app/params"
	"github.com/anon-org/anon/v4/app/upgrades"
	"github.com/anon-org/anon/v4/client/docs"
	anc "github.com/anon-org/anon/v4/types"
	"github.com/anon-org/anon/v4/x/btccheckpoint"
	btccheckpointtypes "github.com/anon-org/anon/v4/x/btccheckpoint/types"
	"github.com/anon-org/anon/v4/x/btclightclient"
	btclightclienttypes "github.com/anon-org/anon/v4/x/btclightclient/types"
	"github.com/anon-org/anon/v4/x/btcstaking"
	btcstakingtypes "github.com/anon-org/anon/v4/x/btcstaking/types"
	"github.com/anon-org/anon/v4/x/checkpointing"
	"github.com/anon-org/anon/v4/x/checkpointing/prepare"
	checkpointingtypes "github.com/anon-org/anon/v4/x/checkpointing/types"
	"github.com/anon-org/anon/v4/x/checkpointing/vote_extensions"
	"github.com/anon-org/anon/v4/x/costaking"
	...
	"github.com/anon-org/anon/v4/x/incentive"
	incentivekeeper "github.com/anon-org/anon/v4/x/incentive/keeper"
	incentivetypes "github.com/anon-org/anon/v4/x/incentive/types"
	"github.com/anon-org/anon/v4/x/mint"
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".anond")
}

var (
	_ runtime.AppI            = (*AnonApp)(nil)
	_ servertypes.Application = (*AnonApp)(nil)
)

// AnonApp extends an ABCI application, but with most of its parameters exported.
...
// NewAnonApp returns a reference to an initialized AnonApp.
func NewAnonApp(
	logger log.Logger,
	db dbm.DB,
	...
	// but this way it makes anon app more testable
	btcConfig := anc.ParseBtcOptionsFromConfig(appOpts)
	...
	// Anon does not want EndBlock processing in staking
...
func (app *AnonApp) RegisterServicesWithoutStaking() {
...
func (app *AnonApp) RegisterStakingQueryAndMigrations() {
...
// GetBaseApp returns the BaseApp of AnonApp
// required by ibctesting
func (app *AnonApp) GetBaseApp() *baseapp.BaseApp {
	return app.BaseApp
}

// Name returns the name of the App
func (app *AnonApp) Name() string { return app.BaseApp.Name() }

// PreBlocker application updates every pre block
func (app *AnonApp) PreBlocker(ctx sdk.Context, _ *abci.RequestFinalizeBlock) (*sdk.ResponsePreBlock, error) {
	return app.ModuleManager.PreBlock(ctx)
}

// BeginBlockForks is intended to be ran in a chain upgrade.
func (app *AnonApp) BeginBlockForks(ctx sdk.Context) {
...
func (app *AnonApp) BeginBlocker(ctx sdk.Context) (sdk.BeginBlock, error) {
	app.BeginBlockForks(ctx)
	return app.ModuleManager.BeginBlock(ctx)
}

// EndBlocker application updates every end block
func (app *AnonApp) EndBlocker(ctx sdk.Context) (sdk.EndBlock, error) {
	return app.ModuleManager.EndBlock(ctx)
}

// InitChainer application update at chain initialization
func (app *AnonApp) InitChainer(ctx sdk.Context, req *abci.RequestInitChain) (*abci.ResponseInitChain, error) {
...
func (app *AnonApp) LoadHeight(height int64) error {
	return app.LoadVersion(height)
}

// ModuleAccountAddrs returns all the app's module account addresses.
func (app *AnonApp) ModuleAccountAddrs() map[string]bool {
...
// LegacyAmino returns AnonApp's amino codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *AnonApp) LegacyAmino() *codec.LegacyAmino {
	return app.legacyAmino
}

// AppCodec returns AnonApp's app codec.
//
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *AnonApp) AppCodec() codec.Codec {
	return app.appCodec
}

// InterfaceRegistry returns anonApp's InterfaceRegistry
func (app *AnonApp) InterfaceRegistry() types.InterfaceRegistry {
	return app.interfaceRegistry
}

func (app *AnonApp) EncodingConfig() *appparams.EncodingConfig {
...
func (app *AnonApp) SimulationManager() *module.SimulationManager {
	return app.sm
}

// RegisterAPIRoutes registers all application module routes with the provided
// API server.
func (app *AnonApp) RegisterAPIRoutes(apiSvr *api.Server, apiConfig config.APIConfig) {
...
func (app *AnonApp) RegisterTxService(clientCtx client.Context) {
	authtx.RegisterTxService(app.BaseApp.GRPCQueryRouter(), clientCtx, app.BaseApp.Simulate, app.interfaceRegistry)
}

// RegisterTendermintService implements the Application.RegisterTendermintService method.
func (app *AnonApp) RegisterTendermintService(clientCtx client.Context) {
...
func (app *AnonApp) RegisterNodeService(clientCtx client.Context, cfg config.Config) {
	nodeservice.RegisterNodeService(clientCtx, app.GRPCQueryRouter(), cfg)
}

// DefaultGenesis returns a default genesis from the registered AppModuleBasic's.
func (a *AnonApp) DefaultGenesis() map[string]json.RawMessage {
	return a.BasicModuleManager.DefaultGenesis(a.appCodec)
}

func (app *AnonApp) TxConfig() client.TxConfig {
	return app.txConfig
}

// AutoCliOpts returns the autocli options for the app.
func (app *AnonApp) AutoCliOpts() autocli.AppOptions {
...
func (app *AnonApp) setupUpgradeStoreLoaders() {
...
func (app *AnonApp) setupUpgradeHandlers() {
	for _, upgrade := range Upgrades {
