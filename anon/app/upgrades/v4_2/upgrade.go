...
// It resets tracked ActiveSats and ActiveNtk for all BTC stakers, NTK stakers, and combined stakers
...
func delegatingToActiveFP(fpBtcPks []anc.BIP340PubKey, activeFps map[string]*ftypes.FinalityProviderDistInfo) bool {
	// check if delegating to an active FP
	isActiveDel := false
