...
Security researchers are essential in identifying vulnerabilities that may impact the Anon ecosystem.
If you have discovered a security vulnerability in the Anon chain or any repository managed by Anon,
...
1. **Refrain from testing vulnerabilities on our publicly accessible environments**, including but not limited to:
  - Anon mainnet.
  - Anon frontend.
  - Anon public testnets.
  - Anon testnet frontend.
...
Send your detailed vulnerability report to `security@anon.io`.

### 2. GitHub Private Vulnerability Reporting

Utilize [GitHub's Private Vulnerability Reporting](https://github.com/anon-org/anon/security/advisories/new)
...
- Demonstrate good faith by not disrupting or degrading Anon's services.
...
For recommendations on how to improve this policy, either submit a pull request or email `security@anon.io`.
