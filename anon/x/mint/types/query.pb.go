...
// source: anon/mint/v1/query.proto
...
func init() {
	proto.RegisterType((*QueryInflationRateRequest)(nil), "anon.mint.v1.QueryInflationRateRequest")
	proto.RegisterType((*QueryInflationRateResponse)(nil), "anon.mint.v1.QueryInflationRateResponse")
	proto.RegisterType((*QueryAnnualProvisionsRequest)(nil), "anon.mint.v1.QueryAnnualProvisionsRequest")
	proto.RegisterType((*QueryAnnualProvisionsResponse)(nil), "anon.mint.v1.QueryAnnualProvisionsResponse")
	proto.RegisterType((*QueryGenesisTimeRequest)(nil), "anon.mint.v1.QueryGenesisTimeRequest")
	proto.RegisterType((*QueryGenesisTimeResponse)(nil), "anon.mint.v1.QueryGenesisTimeResponse")
}

func init() { proto.RegisterFile("anon/mint/v1/query.proto", fileDescriptor_bab217370cac4c70) }
...
func (c *queryClient) InflationRate(ctx context.Context, in *QueryInflationRateRequest, opts ...grpc.CallOption) (*QueryInflationRateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/anon.mint.v1.Query/InflationRate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) AnnualProvisions(ctx context.Context, in *QueryAnnualProvisionsRequest, opts ...grpc.CallOption) (*QueryAnnualProvisionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/anon.mint.v1.Query/AnnualProvisions", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) GenesisTime(ctx context.Context, in *QueryGenesisTimeRequest, opts ...grpc.CallOption) (*QueryGenesisTimeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/anon.mint.v1.Query/GenesisTime", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_InflationRate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anon.mint.v1.Query/InflationRate",
	}
...
func _Query_AnnualProvisions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anon.mint.v1.Query/AnnualProvisions",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_GenesisTime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anon.mint.v1.Query/GenesisTime",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "anon.mint.v1.Query",
	...
	Metadata: "anon/mint/v1/query.proto",
}
