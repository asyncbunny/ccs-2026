...
If --bls-pop is specified, it will use the BLS pop generated via 'anond generate-bls-pop'.
If not specified, the BLS pop will be generated from priv_validator_key.json and bls_key.json.`)
	...
	cmd.Flags().String(FlagBlsPopFilePath, "", "The path to the BLS proof-of-possession file generated via `anon generate-bls-pop`")
