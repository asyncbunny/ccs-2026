...
// source: anon/checkpointing/v1/tx.proto
...
func init() {
	proto.RegisterType((*MsgWrappedCreateValidator)(nil), "anon.checkpointing.v1.MsgWrappedCreateValidator")
	proto.RegisterType((*MsgWrappedCreateValidatorResponse)(nil), "anon.checkpointing.v1.MsgWrappedCreateValidatorResponse")
}

func init() { proto.RegisterFile("anon/checkpointing/v1/tx.proto", fileDescriptor_6b16c54750152c21) }
...
func (c *msgClient) WrappedCreateValidator(ctx context.Context, in *MsgWrappedCreateValidator, opts ...grpc.CallOption) (*MsgWrappedCreateValidatorResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/anon.checkpointing.v1.Msg/WrappedCreateValidator", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_WrappedCreateValidator_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anon.checkpointing.v1.Msg/WrappedCreateValidator",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "anon.checkpointing.v1.Msg",
	...
	Metadata: "anon/checkpointing/v1/tx.proto",
}
