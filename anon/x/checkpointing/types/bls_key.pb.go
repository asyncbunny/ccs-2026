...
// source: anon/checkpointing/v1/bls_key.proto
...
type BlsKey struct {
	...
	Pubkey *github_com_anon_io_anon_v4_crypto_bls12381.PublicKey `protobuf:"bytes,1,opt,name=pubkey,proto3,customtype=github.com/anon-org/anon/v4/crypto/bls12381.PublicKey" json:"pubkey,omitempty"`
...
type ProofOfPossession struct {
	...
	// ed25519_sig)
	BlsSig *github_com_anon_io_anon_v4_crypto_bls12381.Signature `protobuf:"bytes,2,opt,name=bls_sig,json=blsSig,proto3,customtype=github.com/anon-org/anon/v4/crypto/bls12381.Signature" json:"bls_sig,omitempty"`
}
...
type VoteExtension struct {
	...
	BlsSig *github_com_anon_io_anon_v4_crypto_bls12381.Signature `protobuf:"bytes,6,opt,name=bls_sig,json=blsSig,proto3,customtype=github.com/anon-org/anon/v4/crypto/bls12381.Signature" json:"bls_sig,omitempty"`
}
...
func init() {
	proto.RegisterType((*BlsKey)(nil), "anon.checkpointing.v1.BlsKey")
	proto.RegisterType((*ProofOfPossession)(nil), "anon.checkpointing.v1.ProofOfPossession")
	proto.RegisterType((*ValidatorWithBlsKeySet)(nil), "anon.checkpointing.v1.ValidatorWithBlsKeySet")
	proto.RegisterType((*ValidatorWithBlsKey)(nil), "anon.checkpointing.v1.ValidatorWithBlsKey")
	proto.RegisterType((*VoteExtension)(nil), "anon.checkpointing.v1.VoteExtension")
}

func init() {
	proto.RegisterFile("anon/checkpointing/v1/bls_key.proto", fileDescriptor_3a8c0d37ce63f038)
}
