...
the status of Anon's Bitcoin checkpoints. The technical core
...
- handling requests for registering Anon validators with their BLS keys,
...
Anon checkpoints record the state of the Anon chain at
the end of a particular [epoch](../../x/epoching/README.md).
They are created with the intention to be included in
the Bitcoin ledger to protect Anon and
the chains that connect with it against long range attacks.
The confirmation of a Anon checkpoint on Bitcoin
serves as an immutable record of Anon's state
up to the checkpointed epoch and
determines the canonical branch of the Anon chain.
...
and register the BLS public key on Anon.
...
[Vigilante Submitter](https://docs.anon.io/guides/architecture/vigilantes/submitter/).
...
[Vigilante Reporter](https://docs.anon.io/guides/architecture/vigilantes/reporter/)
...
In this case, the Anon chain's canonical chain is represented by
...
[object](../../proto/anon/checkpointing/v1/checkpoint.proto) representing a
...
message RawCheckpoint {
  ...
  [ (gogoproto.customtype) =
    "github.com/anon-org/anon/v4/crypto/bls12381.Signature" ];
}
...
message RawCheckpointWithMeta {
  ...
  bytes bls_aggr_pk = 3
  [ (gogoproto.customtype) =
    "github.com/anon-org/anon/v4/crypto/bls12381.PublicKey" ];
...
The Checkpoint module also stores the [validator set](../../proto/anon/checkpointing/v1/bls_key.proto)
...
The Checkpointing module handles requests of registering Anon validators.
The request message type is defined at
[proto/anon/checkpointing/v1/tx.proto](../../proto/anon/checkpointing/v1/tx.proto).
...
Upon `MsgWrappedCreateValidator`, a Anon node will execute as follows:
...
defined in [x/proto/anon/checkpointing/checkpoint.proto](../../proto/anon/checkpointing/checkpoint.proto).
...
[x/proto/anon/checkpointing/bls_key.proto](../../proto/anon/checkpointing/bls_key.proto).
...
defined at [proto/anon/checkpointing/v1/events.proto](../../proto/anon/checkpointing/v1/events.proto).
...
[docs.anon.io](https://docs.anon.io/docs/developer-guides/grpcrestapi#tag/Checkpointing).
