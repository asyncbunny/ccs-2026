...
type (
	Keeper struct {
		...
		// rewardTrackerEvents maps (anon block height) => types.EventsPowerUpdateAtHeight
		rewardTrackerEvents collections.Map[uint64, types.EventsPowerUpdateAtHeight]
		// rewardTrackerEventsLastProcessedHeight keeps track of the latest processed anon block height of events
