...
[here](../proto/anon/incentive/params.proto)
defined as follows:
...
Upon receiving `MsgUpdateParams`, a Anon node will execute as follows:
...
Upon receiving `MsgSetWithdrawAddress`, a Anon node will execute as follows:
...
Upon receiving `MsgWithdrawReward`, a Anon node will execute as follows:
...
| ----------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| `/anon/incentive/v1/params`                                          | Queries the current parameters of the Incentive module.                  |
| `/anon/incentive/v1/btc_staking_gauge/{height}`                      | Retrieves the BTC staking gauge information for a specific block height. |
| `/anon/incentive/v1/reward_gauges`                                   | Retrieves the reward gauges for all stakeholders.                        |
| `/anon/incentive/v1/delegators/{delegator_address}/withdraw_address` | Queries the withdraw address of a specific delegator.                    |
