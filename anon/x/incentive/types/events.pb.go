...
// source: anon/incentive/events.proto
...
// of BTC rewards, it is indexed by the anon block height which
...
type EventBTCDelegationActivated struct {
	// FpAddr is the anc address of the finality provider
	FpAddr string `protobuf:"bytes,1,opt,name=fp_addr,json=fpAddr,proto3" json:"fp_addr,omitempty"`
	// BtcDelAddr is the anc address of the BTC delegator
...
func init() {
	proto.RegisterType((*EventsPowerUpdateAtHeight)(nil), "anon.incentive.EventsPowerUpdateAtHeight")
	proto.RegisterType((*EventPowerUpdate)(nil), "anon.incentive.EventPowerUpdate")
	proto.RegisterType((*EventBTCDelegationActivated)(nil), "anon.incentive.EventBTCDelegationActivated")
	proto.RegisterType((*EventBTCDelegationUnbonded)(nil), "anon.incentive.EventBTCDelegationUnbonded")
}

func init() { proto.RegisterFile("anon/incentive/events.proto", fileDescriptor_78c8437b872382b3) }
