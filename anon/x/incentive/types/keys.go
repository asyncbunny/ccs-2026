...
var (
	...
	RewardTrackerEvents                        = collections.NewPrefix(10) // key prefix for events of update in the voting power of BTC delegations (anon block height) => []EventsPowerUpdateAtHeight
