...
func (k Keeper) GetExpectedTag(ctx context.Context) txformat.AnonTag {
	...
	return txformat.AnonTag(tagAsBytes)
}
...
func (k Keeper) GetBlockHeight(ctx context.Context, b *anc.BTCHeaderHashBytes) (uint32, error) {
	return k.btcLightClientKeeper.BlockHeight(ctx, b)
}

func (k Keeper) headerDepth(ctx context.Context, headerHash *anc.BTCHeaderHashBytes) (uint32, error) {
