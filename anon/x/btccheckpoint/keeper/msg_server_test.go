...
import (
	...
	bkeeper "github.com/anon-org/anon/v4/x/btccheckpoint/keeper"
...
func b1Hash(m *btcctypes.MsgInsertBTCSpvProof) *anc.BTCHeaderHashBytes {
...
func b2Hash(m *btcctypes.MsgInsertBTCSpvProof) *anc.BTCHeaderHashBytes {
