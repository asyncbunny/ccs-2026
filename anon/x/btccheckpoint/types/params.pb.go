...
// source: anon/btccheckpoint/v1/params.proto
...
type Params struct {
	...
	// (k in research paper)
	BtcConfirmationDepth uint32 `protobuf:"varint,1,opt,name=btc_confirmation_depth,json=btcConfirmationDepth,proto3" json:"btc_confirmation_depth,omitempty" yaml:"btc_confirmation_depth"`
	...
	CheckpointFinalizationTimeout uint32 `protobuf:"varint,2,opt,name=checkpoint_finalization_timeout,json=checkpointFinalizationTimeout,proto3" json:"checkpoint_finalization_timeout,omitempty" yaml:"checkpoint_finalization_timeout"`
...
func (m *Params) GetBtcConfirmationDepth() uint32 {
	if m != nil {
...
func (m *Params) GetCheckpointFinalizationTimeout() uint32 {
	if m != nil {
...
func init() {
	proto.RegisterType((*Params)(nil), "anon.btccheckpoint.v1.Params")
}

func init() {
	proto.RegisterFile("anon/btccheckpoint/v1/params.proto", fileDescriptor_5445a19005ae983c)
}
...
var fileDescriptor_5445a19005ae983c = []byte{
	...
	0xeb, 0xa4, 0xf8, 0xe9, 0x9e, 0xbc, 0x6c, 0x65, 0x62, 0x6e, 0x8e, 0x95, 0x12, 0x76, 0x75, 0x4a,
	...
	0x59, 0xa5, 0x67, 0x96, 0x64, 0x94, 0x26, 0xe9, 0x25, 0xe7, 0xe7, 0xea, 0x43, 0x03, 0x3d, 0x27,
	0x31, 0xa9, 0x58, 0x37, 0x33, 0x1f, 0xc6, 0xd5, 0x2f, 0x33, 0xd1, 0xaf, 0x40, 0x8b, 0xaf, 0x92,
	0xca, 0x82, 0xd4, 0xe2, 0x24, 0x36, 0x70, 0xe0, 0x1b, 0x03, 0x02, 0x00, 0x00, 0xff, 0xff, 0xbb,
	0x91, 0xa7, 0xa7, 0xd5, 0x01, 0x00, 0x00,
}
