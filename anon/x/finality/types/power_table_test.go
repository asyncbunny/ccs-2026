...
import (
	...
	types "github.com/anon-org/anon/v4/x/finality/types"
)
...
var (
	...
	fpPubKey1     = anc.NewBIP340PubKeyFromBTCPK(fpPrivKey1.PubKey())
	fpPubKey2     = anc.NewBIP340PubKeyFromBTCPK(fpPrivKey2.PubKey())
	fpPubKey3     = anc.NewBIP340PubKeyFromBTCPK(fpPrivKey3.PubKey())
...
func TestSortFinalityProvidersWithZeroedVotingPower(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			fps: []*types.FinalityProviderDistInfo{
				{Addr: []byte("fp1"), TotalBondedSat: 100, IsJailed: false, IsTimestamped: true, BtcPk: &anc.BIP340PubKey{0x03}},
				{Addr: []byte("fp2"), TotalBondedSat: 200, IsJailed: false, IsTimestamped: true, BtcPk: &anc.BIP340PubKey{0x02}},
				{Addr: []byte("fp3"), TotalBondedSat: 150, IsJailed: false, IsTimestamped: true, BtcPk: &anc.BIP340PubKey{0x01}},
			},
			expected: []*types.FinalityProviderDistInfo{
				{Addr: []byte("fp2"), TotalBondedSat: 200, IsJailed: false, IsTimestamped: true, BtcPk: &anc.BIP340PubKey{0x02}},
				{Addr: []byte("fp3"), TotalBondedSat: 150, IsJailed: false, IsTimestamped: true, BtcPk: &anc.BIP340PubKey{0x01}},
		...
		},
		{
			...
			fps: []*types.FinalityProviderDistInfo{
				{Addr: []byte("fp1"), TotalBondedSat: 100, IsJailed: false, IsTimestamped: true, BtcPk: &anc.BIP340PubKey{0x04}},
				{Addr: []byte("fp2"), TotalBondedSat: 200, IsJailed: true, IsTimestamped: true, BtcPk: &anc.BIP340PubKey{0x02}},
				{Addr: []byte("fp3"), TotalBondedSat: 150, IsJailed: false, IsTimestamped: false, BtcPk: &anc.BIP340PubKey{0x03}},
				{Addr: []byte("fp4"), TotalBondedSat: 50, IsJailed: false, IsTimestamped: true, BtcPk: &anc.BIP340PubKey{0x01}},
			},
			expected: []*types.FinalityProviderDistInfo{
				{Addr: []byte("fp1"), TotalBondedSat: 100, IsJailed: false, IsTimestamped: true, BtcPk: &anc.BIP340PubKey{0x04}},
				{Addr: []byte("fp4"), TotalBondedSat: 50, IsJailed: false, IsTimestamped: true, BtcPk: &anc.BIP340PubKey{0x01}},
		...
		},
		{
			...
			fps: []*types.FinalityProviderDistInfo{
				{Addr: []byte("fp1"), TotalBondedSat: 100, IsJailed: false, IsTimestamped: true, BtcPk: &anc.BIP340PubKey{0x03}},
				{Addr: []byte("fp2"), TotalBondedSat: 100, IsJailed: false, IsTimestamped: true, BtcPk: &anc.BIP340PubKey{0x01}},
				{Addr: []byte("fp3"), TotalBondedSat: 100, IsJailed: false, IsTimestamped: true, BtcPk: &anc.BIP340PubKey{0x02}},
			},
			expected: []*types.FinalityProviderDistInfo{
				{Addr: []byte("fp2"), TotalBondedSat: 100, IsJailed: false, IsTimestamped: true, BtcPk: &anc.BIP340PubKey{0x01}},
				{Addr: []byte("fp3"), TotalBondedSat: 100, IsJailed: false, IsTimestamped: true, BtcPk: &anc.BIP340PubKey{0x02}},
		...
		},
		{
			...
			fps: []*types.FinalityProviderDistInfo{
				{Addr: []byte("fp1"), TotalBondedSat: 200, IsJailed: true, IsTimestamped: true, BtcPk: &anc.BIP340PubKey{0x03}},
				{Addr: []byte("fp2"), TotalBondedSat: 150, IsJailed: false, IsTimestamped: false, BtcPk: &anc.BIP340PubKey{0x01}},
				{Addr: []byte("fp3"), TotalBondedSat: 100, IsJailed: true, IsTimestamped: false, BtcPk: &anc.BIP340PubKey{0x02}},
			},
			expected: []*types.FinalityProviderDistInfo{
				{Addr: []byte("fp2"), TotalBondedSat: 150, IsJailed: false, IsTimestamped: false, BtcPk: &anc.BIP340PubKey{0x01}},
				{Addr: []byte("fp3"), TotalBondedSat: 100, IsJailed: true, IsTimestamped: false, BtcPk: &anc.BIP340PubKey{0x02}},
