...
// source: anon/finality/v1/params.proto
...
type Params struct {
	...
	// finality_activation_height is the anon block height which the finality module will
...
func init() {
	proto.RegisterType((*Params)(nil), "anon.finality.v1.Params")
}

func init() { proto.RegisterFile("anon/finality/v1/params.proto", fileDescriptor_25539c9a61c72ee9) }
