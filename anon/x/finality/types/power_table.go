...
func (fpdi FinalityProviderDistInfo) Validate() error {
	...
	if fpdi.BtcPk.Size() != anc.BIP340PubKeyLen {
		return fmt.Errorf("invalid fp dist info. finality provider BTC public key length: got %d, want %d", fpdi.BtcPk.Size(), anc.BIP340PubKeyLen)
	}
