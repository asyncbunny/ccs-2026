...
func NewFinalityProviderSigningInfo(
	fpPk *anctypes.BIP340PubKey, startHeight, missedBlocksCounter int64,
...
func (fpsi FinalityProviderSigningInfo) Validate() error {
	...
	if fpsi.FpBtcPk.Size() != anctypes.BIP340PubKeyLen {
		return fmt.Errorf("invalid signing info. finality provider BTC public key length: got %d, want %d", fpsi.FpBtcPk.Size(), anctypes.BIP340PubKeyLen)
	}
