...
// source: anon/finality/v1/events.proto
...
func init() {
	proto.RegisterType((*EventSlashedFinalityProvider)(nil), "anon.finality.v1.EventSlashedFinalityProvider")
	proto.RegisterType((*EventJailedFinalityProvider)(nil), "anon.finality.v1.EventJailedFinalityProvider")
}

func init() { proto.RegisterFile("anon/finality/v1/events.proto", fileDescriptor_c34c03aae5e3e6bf) }
...
var fileDescriptor_c34c03aae5e3e6bf = []byte{
	...
	0xd4, 0x29, 0x39, 0x89, 0x49, 0xc5, 0xba, 0x99, 0xf9, 0x30, 0xae, 0x7e, 0x99, 0x89, 0x7e, 0x05,
	0xc2, 0xd7, 0x25, 0x95, 0x05, 0xa9, 0xc5, 0x49, 0x6c, 0x60, 0x0f, 0x1b, 0x03, 0x02, 0x00, 0x00,
	0xff, 0xff, 0x5c, 0x72, 0x47, 0x32, 0x4d, 0x01, 0x00, 0x00,
}
