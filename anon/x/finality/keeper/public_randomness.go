...
func (k Keeper) GetPubRandCommitForHeight(ctx context.Context, fpBtcPK *anc.BIP340PubKey, height uint64) (*types.PubRandCommit, error) {
...
// height for the given finality provider
func (k Keeper) GetTimestampedPubRandCommitForHeight(ctx context.Context, fpBtcPK *anc.BIP340PubKey, height uint64) (*types.PubRandCommit, error) {
...
func (k Keeper) HasTimestampedPubRand(ctx context.Context, fpBtcPK *anc.BIP340PubKey, height uint64) bool {
...
func (k Keeper) SetPubRandCommit(ctx context.Context, fpBtcPK *anc.BIP340PubKey, prCommit *types.PubRandCommit) error {
	store := k.pubRandCommitFpStore(ctx, fpBtcPK)
...
func (k Keeper) GetLastPubRandCommit(ctx context.Context, fpBtcPK *anc.BIP340PubKey) *types.PubRandCommit {
	store := k.pubRandCommitFpStore(ctx, fpBtcPK)
...
// value: PubRandCommit
func (k Keeper) pubRandCommitFpStore(ctx context.Context, fpBtcPK *anc.BIP340PubKey) prefix.Store {
...
func (k Keeper) SetPubRand(ctx context.Context, fpBtcPK *anc.BIP340PubKey, height uint64, pubRand anc.SchnorrPubRand) {
	store := k.pubRandFpStore(ctx, fpBtcPK)
	store.Set(sdk.Uint64ToBigEndian(height), pubRand)
}

func (k Keeper) HasPubRand(ctx context.Context, fpBtcPK *anc.BIP340PubKey, height uint64) bool {
	store := k.pubRandFpStore(ctx, fpBtcPK)
	return store.Has(sdk.Uint64ToBigEndian(height))
}

func (k Keeper) GetPubRand(ctx context.Context, fpBtcPK *anc.BIP340PubKey, height uint64) (*anc.SchnorrPubRand, error) {
	store := k.pubRandFpStore(ctx, fpBtcPK)
	prBytes := store.Get(sdk.Uint64ToBigEndian(height))
	if len(prBytes) == 0 {
		return nil, types.ErrPubRandNotFound
	}
	return anc.NewSchnorrPubRand(prBytes)
}

// GetLastPubRand retrieves the last public randomness committed by the given finality provider
func (k Keeper) GetLastPubRand(ctx context.Context, fpBtcPK *anc.BIP340PubKey) (uint64, *anc.SchnorrPubRand, error) {
	store := k.pubRandFpStore(ctx, fpBtcPK)
	iter := store.ReverseIterator(nil, nil)
	defer iter.Close()
	...
	pubRand, err := anc.NewSchnorrPubRand(iter.Value())
	if err != nil {
...
func (k Keeper) pubRandFpStore(ctx context.Context, fpBtcPK *anc.BIP340PubKey) prefix.Store {
...
func (k Keeper) upsertPubRandCommitIdx(ctx context.Context, fpBtcPK *anc.BIP340PubKey, startHeight uint64) error {
