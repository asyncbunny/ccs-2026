...
func (k Keeper) GetMissedBlockBitmapValue(ctx context.Context, fpPk *anctypes.BIP340PubKey, index int64) (bool, error) {
...
// chunk.
func (k Keeper) SetMissedBlockBitmapValue(ctx context.Context, fpPk *anctypes.BIP340PubKey, index int64, missed bool) error {
	// get the chunk or "word" in the logical bitmap
	chunkIndex := index / finalitytypes.MissedBlockBitmapChunkSize
...
func (k Keeper) GetFinalityProviderMissedBlocks(ctx context.Context, fpPk *anctypes.BIP340PubKey) ([]finalitytypes.MissedBlock, error) {
...
func (k Keeper) IterateMissedBlockBitmap(ctx context.Context, fpPk *anctypes.BIP340PubKey, cb func(index int64, missed bool) (stop bool)) error {
	var index int64
...
func (k Keeper) DeleteMissedBlockBitmap(ctx context.Context, fpPk *anctypes.BIP340PubKey) error {
	rng := collections.NewPrefixedPairRange[[]byte, uint64](fpPk.MustMarshal())
...
func (k Keeper) SetMissedBlockBitmapChunk(ctx context.Context, fpPk *anctypes.BIP340PubKey, chunkIndex int64, chunk []byte) error {
...
// a finality provider's missed block signing window.
func (k Keeper) getMissedBlockBitmapChunk(ctx context.Context, fpPk *anctypes.BIP340PubKey, chunkIndex int64) ([]byte, error) {
