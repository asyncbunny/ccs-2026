...
func (k Keeper) HasEvidence(ctx context.Context, fpBtcPK *anc.BIP340PubKey, height uint64) bool {
	store := k.evidenceFpStore(ctx, fpBtcPK)
	return store.Has(sdk.Uint64ToBigEndian(height))
}

func (k Keeper) GetEvidence(ctx context.Context, fpBtcPK *anc.BIP340PubKey, height uint64) (*types.Evidence, error) {
...
func (k Keeper) GetFirstSlashableEvidence(ctx context.Context, fpBtcPK *anc.BIP340PubKey) *types.Evidence {
	store := k.evidenceFpStore(ctx, fpBtcPK)
...
// value: Evidence
func (k Keeper) evidenceFpStore(ctx context.Context, fpBTCPK *anc.BIP340PubKey) prefix.Store {
