...
// source: anon/monitor/v1/query.proto
...
func init() {
	proto.RegisterType((*QueryEndedEpochBtcHeightRequest)(nil), "anon.monitor.v1.QueryEndedEpochBtcHeightRequest")
	proto.RegisterType((*QueryEndedEpochBtcHeightResponse)(nil), "anon.monitor.v1.QueryEndedEpochBtcHeightResponse")
	proto.RegisterType((*QueryReportedCheckpointBtcHeightRequest)(nil), "anon.monitor.v1.QueryReportedCheckpointBtcHeightRequest")
	proto.RegisterType((*QueryReportedCheckpointBtcHeightResponse)(nil), "anon.monitor.v1.QueryReportedCheckpointBtcHeightResponse")
}

func init() { proto.RegisterFile("anon/monitor/v1/query.proto", fileDescriptor_a8aafb034c55a8f2) }
...
type QueryClient interface {
	...
	// the checkpoint with the given hash is reported back to Anon
...
func (c *queryClient) EndedEpochBtcHeight(ctx context.Context, in *QueryEndedEpochBtcHeightRequest, opts ...grpc.CallOption) (*QueryEndedEpochBtcHeightResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/anon.monitor.v1.Query/EndedEpochBtcHeight", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ReportedCheckpointBtcHeight(ctx context.Context, in *QueryReportedCheckpointBtcHeightRequest, opts ...grpc.CallOption) (*QueryReportedCheckpointBtcHeightResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/anon.monitor.v1.Query/ReportedCheckpointBtcHeight", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_EndedEpochBtcHeight_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anon.monitor.v1.Query/EndedEpochBtcHeight",
	}
...
func _Query_ReportedCheckpointBtcHeight_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anon.monitor.v1.Query/ReportedCheckpointBtcHeight",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "anon.monitor.v1.Query",
	...
	Metadata: "anon/monitor/v1/query.proto",
}
