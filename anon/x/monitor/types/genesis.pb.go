...
// source: anon/monitor/v1/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "anon.monitor.v1.GenesisState")
	proto.RegisterType((*EpochEndLightClient)(nil), "anon.monitor.v1.EpochEndLightClient")
	proto.RegisterType((*CheckpointReportedLightClient)(nil), "anon.monitor.v1.CheckpointReportedLightClient")
}

func init() { proto.RegisterFile("anon/monitor/v1/genesis.proto", fileDescriptor_fb844fd916189e7b) }
