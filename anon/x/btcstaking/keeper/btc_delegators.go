...
func (k Keeper) getBTCDelegatorDelegationIndex(ctx context.Context, fpBTCPK *anc.BIP340PubKey, delBTCPK *anc.BIP340PubKey) *types.BTCDelegatorDelegationIndex {
...
func (k Keeper) setBTCDelegatorDelegationIndex(ctx context.Context, fpBTCPK, delBTCPK *anc.BIP340PubKey, btcDelIndex *types.BTCDelegatorDelegationIndex) {
	store := k.btcDelegatorFpStore(ctx, fpBTCPK)
...
func (k Keeper) getBTCDelegatorDelegations(ctx context.Context, fpBTCPK *anc.BIP340PubKey, delBTCPK *anc.BIP340PubKey) *types.BTCDelegatorDelegations {
...
// This function works for both Anon finality providers and consumer finality providers.
...
func (k Keeper) HandleFPBTCDelegations(ctx context.Context, fpBTCPK *anc.BIP340PubKey, handler func(*types.BTCDelegation) error) error {
...
// sats staked to it
func (k Keeper) FpTotalSatsStaked(ctx context.Context, fpBTCPK *anc.BIP340PubKey) (uint64, error) {
	totalVp := 0
...
func (k Keeper) btcDelegatorFpStore(ctx context.Context, fpBTCPK *anc.BIP340PubKey) prefix.Store {
