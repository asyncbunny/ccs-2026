...
// source: anon/btcstaking/v1/genesis.proto
...
type GenesisState struct {
	...
	// block_height_chains the block height of anon and bitcoin.
	BlockHeightChains []*BlockHeightAncToBtc `protobuf:"bytes,5,rep,name=block_height_chains,json=blockHeightChains,proto3" json:"block_height_chains,omitempty"`
	...
	// FpAncAddr defines a list of the finality provider indexed by their anon address.
	FpAncAddr []string `protobuf:"bytes,12,rep,name=fp_anc_addr,json=fpAncAddr,proto3" json:"fp_anc_addr,omitempty"`
...
func (m *GenesisState) GetBlockHeightChains() []*BlockHeightAncToBtc {
	if m != nil {
...
func (m *GenesisState) GetFpAncAddr() []string {
	if m != nil {
		return m.FpAncAddr
	}
	return nil
...
// BlockHeightAncToBtc stores the btc <-> anc block.
type BlockHeightAncToBtc struct {
	// block_height_anc is the height of the block in the anon chain.
	BlockHeightAnc uint64 `protobuf:"varint,1,opt,name=block_height_anc,json=blockHeightAnc,proto3" json:"block_height_anc,omitempty"`
...
func (m *BlockHeightAncToBtc) Reset()         { *m = BlockHeightAncToBtc{} }
func (m *BlockHeightAncToBtc) String() string { return proto.CompactTextString(m) }
func (*BlockHeightAncToBtc) ProtoMessage()    {}
func (*BlockHeightAncToBtc) Descriptor() ([]byte, []int) {
	return fileDescriptor_85d7b95fa5620238, []int{1}
}
func (m *BlockHeightAncToBtc) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BlockHeightAncToBtc) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BlockHeightAncToBtc.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *BlockHeightAncToBtc) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BlockHeightAncToBtc.Merge(m, src)
}
func (m *BlockHeightAncToBtc) XXX_Size() int {
	return m.Size()
}
func (m *BlockHeightAncToBtc) XXX_DiscardUnknown() {
	xxx_messageInfo_BlockHeightAncToBtc.DiscardUnknown(m)
}

var xxx_messageInfo_BlockHeightAncToBtc proto.InternalMessageInfo

func (m *BlockHeightAncToBtc) GetBlockHeightAnc() uint64 {
	if m != nil {
		return m.BlockHeightAnc
	}
	return 0
}

func (m *BlockHeightAncToBtc) GetBlockHeightBtc() uint32 {
	if m != nil {
...
type BTCDelegator struct {
	...
	DelBtcPk *github_com_anon_io_anon_v4_types.BIP340PubKey `protobuf:"bytes,3,opt,name=del_btc_pk,json=delBtcPk,proto3,customtype=github.com/anon-org/anon/v4/types.BIP340PubKey" json:"del_btc_pk,omitempty"`
}
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "anon.btcstaking.v1.GenesisState")
	proto.RegisterType((*BlockHeightAncToBtc)(nil), "anon.btcstaking.v1.BlockHeightAncToBtc")
	proto.RegisterType((*BTCDelegator)(nil), "anon.btcstaking.v1.BTCDelegator")
	proto.RegisterType((*EventIndex)(nil), "anon.btcstaking.v1.EventIndex")
}

func init() {
	proto.RegisterFile("anon/btcstaking/v1/genesis.proto", fileDescriptor_85d7b95fa5620238)
}
...
func (m *GenesisState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.FpAncAddr) > 0 {
		for iNdEx := len(m.FpAncAddr) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.FpAncAddr[iNdEx])
			copy(dAtA[i:], m.FpAncAddr[iNdEx])
			i = encodeVarintGenesis(dAtA, i, uint64(len(m.FpAncAddr[iNdEx])))
			i--
			dAtA[i] = 0x62
		}
	}
...
func (m *BlockHeightAncToBtc) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BlockHeightAncToBtc) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BlockHeightAncToBtc) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.BlockHeightAnc != 0 {
		i = encodeVarintGenesis(dAtA, i, uint64(m.BlockHeightAnc))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *BlockHeightAncToBtc) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.BlockHeightAnc != 0 {
		n += 1 + sovGenesis(uint64(m.BlockHeightAnc))
	}
	if m.BlockHeightBtc != 0 {
...
func (m *GenesisState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			m.BlockHeightChains = append(m.BlockHeightChains, &BlockHeightAncToBtc{})
		...
		case 12:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FpAncAddr", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.FpAncAddr = append(m.FpAncAddr, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 13:
			if wireType != 2 {
...
func (m *BlockHeightAncToBtc) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BlockHeightAncToBtc: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BlockHeightAncToBtc: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field BlockHeightAnc", wireType)
			}
			m.BlockHeightAnc = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.BlockHeightAnc |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
