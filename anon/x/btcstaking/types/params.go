...
func DefaultParams() Params {
	...
	return Params{
		CovenantPks:          anc.NewBIP340PKsFromBTCPKs(pks),
...
func validateCovenantPks(covenantPks []anc.BIP340PubKey) error {
...
func (p Params) HasCovenantPK(pk *anc.BIP340PubKey) bool {
...
func (p Params) MustGetCovenantPks() []*btcec.PublicKey {
	covenantKeys, err := anc.NewBTCPKsFromBIP340PKs(p.CovenantPks)
