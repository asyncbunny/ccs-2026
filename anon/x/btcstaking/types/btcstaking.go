...
func ExistsDup(btcPKs []anc.BIP340PubKey) (bool, error) {
...
func NewSignatureInfo(pk *anc.BIP340PubKey, sig *anc.BIP340Signature) *SignatureInfo {
...
func GetOrderedCovenantSignatures(fpIdx int, covSigsList []*CovenantAdaptorSignatures, params *Params) ([]*asig.AdaptorSignature, error) {
	...
	orderedCovenantPKs := anc.SortBIP340PKs(params.CovenantPks)
