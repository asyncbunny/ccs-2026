...
// source: anon/btcstaking/v1/tx.proto
...
type MsgCreateBTCDelegation struct {
	...
	BtcPk *github_com_anon_io_anon_v4_types.BIP340PubKey `protobuf:"bytes,3,opt,name=btc_pk,json=btcPk,proto3,customtype=github.com/anon-org/anon/v4/types.BIP340PubKey" json:"btc_pk,omitempty"`
	...
	FpBtcPkList []github_com_anon_io_anon_v4_types.BIP340PubKey `protobuf:"bytes,4,rep,name=fp_btc_pk_list,json=fpBtcPkList,proto3,customtype=github.com/anon-org/anon/v4/types.BIP340PubKey" json:"fp_btc_pk_list,omitempty"`
	...
	DelegatorSlashingSig *github_com_anon_io_anon_v4_types.BIP340Signature `protobuf:"bytes,10,opt,name=delegator_slashing_sig,json=delegatorSlashingSig,proto3,customtype=github.com/anon-org/anon/v4/types.BIP340Signature" json:"delegator_slashing_sig,omitempty"`
	...
	DelegatorUnbondingSlashingSig *github_com_anon_io_anon_v4_types.BIP340Signature `protobuf:"bytes,15,opt,name=delegator_unbonding_slashing_sig,json=delegatorUnbondingSlashingSig,proto3,customtype=github.com/anon-org/anon/v4/types.BIP340Signature" json:"delegator_unbonding_slashing_sig,omitempty"`
}
...
type MsgBtcStakeExpand struct {
	...
	// the staking tx output. The staking tx output further needs signatures from
	// covenant and finality provider in order to be spendable.
	DelegatorSlashingSig *github_com_anon_io_anon_v4_types.BIP340Signature `protobuf:"bytes,9,opt,name=delegator_slashing_sig,json=delegatorSlashingSig,proto3,customtype=github.com/anon-org/anon/v4/types.BIP340Signature" json:"delegator_slashing_sig,omitempty"`
	// unbonding_time is the time lock used when funds are being unbonded. It is
	// be used in:
	// - unbonding transaction, time lock spending path
	// - staking slashing transaction, change output
	...
	// delegator_unbonding_slashing_sig is the signature on the slashing tx by the
	// delegator (i.e., SK corresponding to btc_pk).
	DelegatorUnbondingSlashingSig *github_com_anon_io_anon_v4_types.BIP340Signature `protobuf:"bytes,14,opt,name=delegator_unbonding_slashing_sig,json=delegatorUnbondingSlashingSig,proto3,customtype=github.com/anon-org/anon/v4/types.BIP340Signature" json:"delegator_unbonding_slashing_sig,omitempty"`
	// previous_staking_tx_hash is the hash of the staking tx that will be used as input.
	PreviousStakingTxHash string `protobuf:"bytes,15,opt,name=previous_staking_tx_hash,json=previousStakingTxHash,proto3" json:"previous_staking_tx_hash,omitempty"`
	...
	FundingTx []byte `protobuf:"bytes,16,opt,name=funding_tx,json=fundingTx,proto3" json:"funding_tx,omitempty"`
}
...
func (m *MsgBtcStakeExpand) GetFundingTx() []byte {
	if m != nil {
		return m.FundingTx
	}
	return nil
...
type MsgAddCovenantSigs struct {
	...
	Pk *github_com_anon_io_anon_v4_types.BIP340PubKey `protobuf:"bytes,2,opt,name=pk,proto3,customtype=github.com/anon-org/anon/v4/types.BIP340PubKey" json:"pk,omitempty"`
	// staking_tx_hash is the hash of the staking tx.
	// It uniquely identifies a BTC delegation
	...
	// submitted to anon the signature follows encoding in BIP-340 spec
	UnbondingTxSig *github_com_anon_io_anon_v4_types.BIP340Signature `protobuf:"bytes,5,opt,name=unbonding_tx_sig,json=unbondingTxSig,proto3,customtype=github.com/anon-org/anon/v4/types.BIP340Signature" json:"unbonding_tx_sig,omitempty"`
	...
	// submitted to anon. The signature follows encoding in BIP-340 spec
	StakeExpansionTxSig *github_com_anon_io_anon_v4_types.BIP340Signature `protobuf:"bytes,7,opt,name=stake_expansion_tx_sig,json=stakeExpansionTxSig,proto3,customtype=github.com/anon-org/anon/v4/types.BIP340Signature" json:"stake_expansion_tx_sig,omitempty"`
}
...
func init() {
	proto.RegisterType((*MsgCreateFinalityProvider)(nil), "anon.btcstaking.v1.MsgCreateFinalityProvider")
	proto.RegisterType((*MsgCreateFinalityProviderResponse)(nil), "anon.btcstaking.v1.MsgCreateFinalityProviderResponse")
	proto.RegisterType((*CommissionRates)(nil), "anon.btcstaking.v1.CommissionRates")
	proto.RegisterType((*MsgEditFinalityProvider)(nil), "anon.btcstaking.v1.MsgEditFinalityProvider")
	proto.RegisterType((*MsgEditFinalityProviderResponse)(nil), "anon.btcstaking.v1.MsgEditFinalityProviderResponse")
	proto.RegisterType((*MsgCreateBTCDelegation)(nil), "anon.btcstaking.v1.MsgCreateBTCDelegation")
	proto.RegisterType((*MsgCreateBTCDelegationResponse)(nil), "anon.btcstaking.v1.MsgCreateBTCDelegationResponse")
	proto.RegisterType((*MsgBtcStakeExpand)(nil), "anon.btcstaking.v1.MsgBtcStakeExpand")
	proto.RegisterType((*MsgBtcStakeExpandResponse)(nil), "anon.btcstaking.v1.MsgBtcStakeExpandResponse")
	proto.RegisterType((*MsgAddBTCDelegationInclusionProof)(nil), "anon.btcstaking.v1.MsgAddBTCDelegationInclusionProof")
	proto.RegisterType((*MsgAddBTCDelegationInclusionProofResponse)(nil), "anon.btcstaking.v1.MsgAddBTCDelegationInclusionProofResponse")
	proto.RegisterType((*MsgAddCovenantSigs)(nil), "anon.btcstaking.v1.MsgAddCovenantSigs")
	proto.RegisterType((*MsgAddCovenantSigsResponse)(nil), "anon.btcstaking.v1.MsgAddCovenantSigsResponse")
	proto.RegisterType((*MsgBTCUndelegate)(nil), "anon.btcstaking.v1.MsgBTCUndelegate")
	proto.RegisterType((*MsgBTCUndelegateResponse)(nil), "anon.btcstaking.v1.MsgBTCUndelegateResponse")
	proto.RegisterType((*MsgSelectiveSlashingEvidence)(nil), "anon.btcstaking.v1.MsgSelectiveSlashingEvidence")
	proto.RegisterType((*MsgSelectiveSlashingEvidenceResponse)(nil), "anon.btcstaking.v1.MsgSelectiveSlashingEvidenceResponse")
	proto.RegisterType((*MsgUpdateParams)(nil), "anon.btcstaking.v1.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "anon.btcstaking.v1.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("anon/btcstaking/v1/tx.proto", fileDescriptor_4baddb53e97f38f2) }
...
var fileDescriptor_4baddb53e97f38f2 = []byte{
	...
	,
}
...
func (c *msgClient) CreateFinalityProvider(ctx context.Context, in *MsgCreateFinalityProvider, opts ...grpc.CallOption) (*MsgCreateFinalityProviderResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/anon.btcstaking.v1.Msg/CreateFinalityProvider", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) EditFinalityProvider(ctx context.Context, in *MsgEditFinalityProvider, opts ...grpc.CallOption) (*MsgEditFinalityProviderResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/anon.btcstaking.v1.Msg/EditFinalityProvider", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) CreateBTCDelegation(ctx context.Context, in *MsgCreateBTCDelegation, opts ...grpc.CallOption) (*MsgCreateBTCDelegationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/anon.btcstaking.v1.Msg/CreateBTCDelegation", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) AddBTCDelegationInclusionProof(ctx context.Context, in *MsgAddBTCDelegationInclusionProof, opts ...grpc.CallOption) (*MsgAddBTCDelegationInclusionProofResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/anon.btcstaking.v1.Msg/AddBTCDelegationInclusionProof", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) AddCovenantSigs(ctx context.Context, in *MsgAddCovenantSigs, opts ...grpc.CallOption) (*MsgAddCovenantSigsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/anon.btcstaking.v1.Msg/AddCovenantSigs", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) BTCUndelegate(ctx context.Context, in *MsgBTCUndelegate, opts ...grpc.CallOption) (*MsgBTCUndelegateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/anon.btcstaking.v1.Msg/BTCUndelegate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SelectiveSlashingEvidence(ctx context.Context, in *MsgSelectiveSlashingEvidence, opts ...grpc.CallOption) (*MsgSelectiveSlashingEvidenceResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/anon.btcstaking.v1.Msg/SelectiveSlashingEvidence", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/anon.btcstaking.v1.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) BtcStakeExpand(ctx context.Context, in *MsgBtcStakeExpand, opts ...grpc.CallOption) (*MsgBtcStakeExpandResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/anon.btcstaking.v1.Msg/BtcStakeExpand", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateFinalityProvider_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anon.btcstaking.v1.Msg/CreateFinalityProvider",
	}
...
func _Msg_EditFinalityProvider_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anon.btcstaking.v1.Msg/EditFinalityProvider",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_CreateBTCDelegation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anon.btcstaking.v1.Msg/CreateBTCDelegation",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_AddBTCDelegationInclusionProof_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anon.btcstaking.v1.Msg/AddBTCDelegationInclusionProof",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_AddCovenantSigs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anon.btcstaking.v1.Msg/AddCovenantSigs",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_BTCUndelegate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anon.btcstaking.v1.Msg/BTCUndelegate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_SelectiveSlashingEvidence_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anon.btcstaking.v1.Msg/SelectiveSlashingEvidence",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anon.btcstaking.v1.Msg/UpdateParams",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_BtcStakeExpand_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anon.btcstaking.v1.Msg/BtcStakeExpand",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "anon.btcstaking.v1.Msg",
	...
	Metadata: "anon/btcstaking/v1/tx.proto",
}
...
func (m *MsgAddCovenantSigs) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.StakeExpansionTxSig != nil {
		{
			size := m.StakeExpansionTxSig.Size()
			i -= size
			if _, err := m.StakeExpansionTxSig.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
			i = encodeVarintTx(dAtA, i, uint64(size))
		}
...
func (m *MsgCreateBTCDelegation) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			...
			var v github_com_anon_io_anon_v4_types.BIP340Signature
...
func (m *MsgBtcStakeExpand) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 16:
			...
			m.FundingTx = append(m.FundingTx[:0], dAtA[iNdEx:postIndex]...)
			if m.FundingTx == nil {
				m.FundingTx = []byte{}
			}
			iNdEx = postIndex
...
func (m *MsgAddCovenantSigs) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field StakeExpansionTxSig", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			var v github_com_anon_io_anon_v4_types.BIP340Signature
			m.StakeExpansionTxSig = &v
			if err := m.StakeExpansionTxSig.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
