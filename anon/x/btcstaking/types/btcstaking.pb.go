...
// source: anon/btcstaking/v1/btcstaking.proto
...
import (
	...
	types1 "github.com/anon-org/anon/v4/x/btccheckpoint/types"
	types2 "github.com/anon-org/anon/v4/x/btclightclient/types"
...
// activating delegation on Anon chain.
...
func (m *FinalityProvider) GetSlashedAnonHeight() uint64 {
	if m != nil {
...
func (m *FinalityProviderWithMeta) GetSlashedAnonHeight() uint64 {
	if m != nil {
		return m.SlashedAnonHeight
	}
	return 0
...
type BTCDelegation struct {
	...
	DelegatorSig *github_com_anon_io_anon_v4_types.BIP340Signature `protobuf:"bytes,12,opt,name=delegator_sig,json=delegatorSig,proto3,customtype=github.com/anon-org/anon/v4/types.BIP340Signature" json:"delegator_sig,omitempty"`
...
type BTCUndelegation struct {
	...
	DelegatorSlashingSig *github_com_anon_io_anon_v4_types.BIP340Signature `protobuf:"bytes,3,opt,name=delegator_slashing_sig,json=delegatorSlashingSig,proto3,customtype=github.com/anon-org/anon/v4/types.BIP340Signature" json:"delegator_slashing_sig,omitempty"`
...
type SignatureInfo struct {
	...
	Sig *github_com_anon_io_anon_v4_types.BIP340Signature `protobuf:"bytes,2,opt,name=sig,proto3,customtype=github.com/anon-org/anon/v4/types.BIP340Signature" json:"sig,omitempty"`
}
...
type CovenantAdaptorSignatures struct {
	...
	CovPk *github_com_anon_io_anon_v4_types.BIP340PubKey `protobuf:"bytes,1,opt,name=cov_pk,json=covPk,proto3,customtype=github.com/anon-org/anon/v4/types.BIP340PubKey" json:"cov_pk,omitempty"`
...
type SelectiveSlashingEvidence struct {
	...
	FpBtcPk *github_com_anon_io_anon_v4_types.BIP340PubKey `protobuf:"bytes,2,opt,name=fp_btc_pk,json=fpBtcPk,proto3,customtype=github.com/anon-org/anon/v4/types.BIP340PubKey" json:"fp_btc_pk,omitempty"`
...
func init() {
	proto.RegisterEnum("anon.btcstaking.v1.BTCDelegationStatus", BTCDelegationStatus_name, BTCDelegationStatus_value)
	proto.RegisterType((*FinalityProvider)(nil), "anon.btcstaking.v1.FinalityProvider")
	proto.RegisterType((*CommissionInfo)(nil), "anon.btcstaking.v1.CommissionInfo")
	proto.RegisterType((*FinalityProviderWithMeta)(nil), "anon.btcstaking.v1.FinalityProviderWithMeta")
	proto.RegisterType((*BTCDelegation)(nil), "anon.btcstaking.v1.BTCDelegation")
	proto.RegisterType((*StakeExpansion)(nil), "anon.btcstaking.v1.StakeExpansion")
	proto.RegisterType((*DelegatorUnbondingInfo)(nil), "anon.btcstaking.v1.DelegatorUnbondingInfo")
	proto.RegisterType((*BTCUndelegation)(nil), "anon.btcstaking.v1.BTCUndelegation")
	proto.RegisterType((*BTCDelegatorDelegations)(nil), "anon.btcstaking.v1.BTCDelegatorDelegations")
	proto.RegisterType((*BTCDelegatorDelegationIndex)(nil), "anon.btcstaking.v1.BTCDelegatorDelegationIndex")
	proto.RegisterType((*SignatureInfo)(nil), "anon.btcstaking.v1.SignatureInfo")
	proto.RegisterType((*CovenantAdaptorSignatures)(nil), "anon.btcstaking.v1.CovenantAdaptorSignatures")
	proto.RegisterType((*SelectiveSlashingEvidence)(nil), "anon.btcstaking.v1.SelectiveSlashingEvidence")
	proto.RegisterType((*InclusionProof)(nil), "anon.btcstaking.v1.InclusionProof")
	proto.RegisterType((*LargestBtcReOrg)(nil), "anon.btcstaking.v1.LargestBtcReOrg")
}

func init() {
	proto.RegisterFile("anon/btcstaking/v1/btcstaking.proto", fileDescriptor_3851ae95ccfaf7db)
}
...
func (m *FinalityProvider) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.SlashedAnonHeight != 0 {
		i = encodeVarintBtcstaking(dAtA, i, uint64(m.SlashedAnonHeight))
		i--
		dAtA[i] = 0x30
	}
	if m.Pop != nil {
...
func (m *FinalityProvider) Size() (n int) {
	...
	if m.SlashedAnonHeight != 0 {
		n += 1 + sovBtcstaking(uint64(m.SlashedAnonHeight))
	}
	if m.SlashedBtcHeight != 0 {
