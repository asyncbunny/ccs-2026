...
func NewFinalityProviderResponse(f *FinalityProvider, ancBlockHeight uint64, softDeleted bool) *FinalityProviderResponse {
	return &FinalityProviderResponse{
		...
		BtcPk:                f.BtcPk,
		Pop:                  f.Pop,
		SlashedAnonHeight: f.SlashedAnonHeight,
		SlashedBtcHeight:     f.SlashedBtcHeight,
		Jailed:               f.Jailed,
		Height:               ancBlockHeight,
