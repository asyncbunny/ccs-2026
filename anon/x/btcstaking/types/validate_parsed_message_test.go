...
import (
	...
	btcckpttypes "github.com/anon-org/anon/v4/x/btccheckpoint/types"
...
type unbondingInfo struct {
	...
	unbondingSlashinSig   *anc.BIP340Signature
...
func generateUnbondingInfo(
	...
	covPKs, err := anc.NewBTCPKsFromBIP340PKs(p.CovenantPks)
	require.NoError(t, err)
...
func createMsgDelegationForParams(
	...
	require.NoError(t, err)
	stPk := anc.NewBIP340PubKeyFromBTCPK(delPK)
	...
	require.NoError(t, err)
	fpPkAnc := anc.NewBIP340PubKeyFromBTCPK(fpPk)
	// covenants
	covPKs, err := anc.NewBTCPKsFromBIP340PKs(p.CovenantPks)
	require.NoError(t, err)
	...
	msgCreateBTCDel := &types.MsgCreateBTCDelegation{
		...
		BtcPk:                         stPk,
		FpBtcPkList:                   []anc.BIP340PubKey{*fpPkAnc},
		Pop:                           pop,
	...
	tests := []struct {
		...
		},
		{
			...
			fn: func(r *rand.Rand, t *testing.T) (*types.MsgCreateBTCDelegation, *types.Params, *btcckpttypes.Params) {
				...
				msg.FpBtcPkList = []anc.BIP340PubKey{}
		...
		},
		{
			...
			fn: func(r *rand.Rand, t *testing.T) (*types.MsgCreateBTCDelegation, *types.Params, *btcckpttypes.Params) {
				...
				// invalid time
				currentStakingTx, err := anc.NewBTCTxFromBytes(msg.StakingTx)
				require.NoError(t, err)

				invalidStakingTime := uint16(params.MinStakingTimeBlocks - 1)

				covPKs, err := anc.NewBTCPKsFromBIP340PKs(params.CovenantPks)
				require.NoError(t, err)
				...
				serializedNewStakingTx, err := anc.SerializeBTCTx(currentStakingTx)
				require.NoError(t, err)
		...
		},
		{
			...
			fn: func(r *rand.Rand, t *testing.T) (*types.MsgCreateBTCDelegation, *types.Params, *btcckpttypes.Params) {
				...
				currentSlashingTx, err := anc.NewBTCTxFromBytes(*msg.SlashingTx)
				require.NoError(t, err)
				...
				serializedNewSlashingTx, err := anc.SerializeBTCTx(currentSlashingTx)
				require.NoError(t, err)
		...
		},
		{
			...
			fn: func(r *rand.Rand, t *testing.T) (*types.MsgCreateBTCDelegation, *types.Params, *btcckpttypes.Params) {
				...
				newSig, err := anc.NewBIP340Signature(invalidSlashingSig)
				require.NoError(t, err)
		...
		},
		{
			...
			fn: func(r *rand.Rand, t *testing.T) (*types.MsgCreateBTCDelegation, *types.Params, *btcckpttypes.Params) {
				...
				currentSlashingTx, err := anc.NewBTCTxFromBytes(*msg.UnbondingSlashingTx)
				require.NoError(t, err)
		...
		},
		{
			...
			fn: func(r *rand.Rand, t *testing.T) (*types.MsgCreateBTCDelegation, *types.Params, *btcckpttypes.Params) {
				...
				currentUnbondingSlashingTx, err := anc.NewBTCTxFromBytes(*msg.UnbondingSlashingTx)
				require.NoError(t, err)
				...
				serializedNewSlashingTx, err := anc.SerializeBTCTx(currentUnbondingSlashingTx)
				require.NoError(t, err)
				msg.UnbondingSlashingTx = types.NewBtcSlashingTxFromBytes(serializedNewSlashingTx)
		...
		},
		{
			...
			fn: func(r *rand.Rand, t *testing.T) (*types.MsgCreateBTCDelegation, *types.Params, *btcckpttypes.Params) {
				...
				currentUnbondingTx, err := anc.NewBTCTxFromBytes(msg.UnbondingTx)
				require.NoError(t, err)
		...
		},
		{
			...
			fn: func(r *rand.Rand, t *testing.T) (*types.MsgCreateBTCDelegation, *types.Params, *btcckpttypes.Params) {
				...
				msg.UnbondingTx, err = anc.SerializeBTCTx(currentUnbondingTx)
				require.NoError(t, err)
