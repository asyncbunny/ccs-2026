...
func NewEventPowerDistUpdateWithSlashedFP(fpBTCPK *anc.BIP340PubKey) *EventPowerDistUpdate {
	return &EventPowerDistUpdate{
...
func NewEventPowerDistUpdateWithJailedFP(fpBTCPK *anc.BIP340PubKey) *EventPowerDistUpdate {
	return &EventPowerDistUpdate{
...
func NewEventPowerDistUpdateWithUnjailedFP(fpBTCPK *anc.BIP340PubKey) *EventPowerDistUpdate {
	return &EventPowerDistUpdate{
...
func NewCovenantSignatureReceivedEvent(
	...
	stakeExpansionTxSig *anc.BIP340Signature,
...
func EmitSlashedFPEvent(sdkCtx sdk.Context, fpBTCPK *anc.BIP340PubKey) {
...
func EmitJailedFPEvent(sdkCtx sdk.Context, fpBTCPK *anc.BIP340PubKey) {
