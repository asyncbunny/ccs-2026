...
import (
	...
	v2 "github.com/anon-org/anon/v4/x/btcstaking/migrations/v2"
...
func TestMigrateStore(t *testing.T) {
	...
	// Populate FpAncAddrKey that should remain unchanged after migration
	testFpAddr := datagen.GenRandomAddress()
	err = btcstakingKeeper.SetFpAncAddr(ctx, testFpAddr)
	require.NoError(t, err)

	// Verify FpAncAddrKey is set before migration
	...
	// Verify FpAncAddrKey remains unchanged after migration
