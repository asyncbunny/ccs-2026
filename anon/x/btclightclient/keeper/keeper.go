...
func (k Keeper) InsertHeadersWithHookAndEvents(ctx context.Context, headers []anc.BTCHeaderBytes) error {
	if len(headers) == 0 {
...
func (k Keeper) InsertHeaders(ctx context.Context, headers []anc.BTCHeaderBytes) error {
	if len(headers) == 0 {
		return types.ErrEmptyMessage
	}
...
func BtcHeadersBytesToBlockHeader(headers []anc.BTCHeaderBytes) []*wire.BlockHeader {
...
func (k Keeper) BlockHeight(ctx context.Context, headerHash *anc.BTCHeaderHashBytes) (uint32, error) {
	if headerHash == nil {
...
func (k Keeper) MainChainDepth(ctx context.Context, headerHashBytes *anc.BTCHeaderHashBytes) (uint32, error) {
...
func (k Keeper) GetHeaderByHash(ctx context.Context, hash *anc.BTCHeaderHashBytes) (*types.BTCHeaderInfo, error) {
