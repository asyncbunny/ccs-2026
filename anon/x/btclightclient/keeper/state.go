...
func (s headersState) GetHeaderByHash(hash *anc.BTCHeaderHashBytes) (*types.BTCHeaderInfo, error) {
	// Keyed by hash
...
func (s headersState) HeaderExists(hash *anc.BTCHeaderHashBytes) bool {
	if hash == nil {
		return false
	}
