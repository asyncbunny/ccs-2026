...
func verifyWrappedDelegateResult(t *testing.T, helper *testhelper.Helper, ctx sdk.Context,
	...
	initialBalance := helper.App.BankKeeper.GetBalance(ctx, delegatorAddr, "uanc")
	delegatePoolAddr := helper.App.AccountKeeper.GetModuleAddress(types.DelegatePoolModuleName)
	initialPoolBalance := helper.App.BankKeeper.GetBalance(ctx, delegatePoolAddr, "uanc")
	...
	if expectError {
		...
		finalBalance := helper.App.BankKeeper.GetBalance(ctx, delegatorAddr, "uanc")
		finalPoolBalance := helper.App.BankKeeper.GetBalance(ctx, delegatePoolAddr, "uanc")
		...
		balanceAfterLock := helper.App.BankKeeper.GetBalance(ctx, delegatorAddr, "uanc")
		...
		poolBalanceAfterLock := helper.App.BankKeeper.GetBalance(ctx, delegatePoolAddr, "uanc")
...
func TestLockFunds_WrappedDelegate(t *testing.T) {
	...
	amount := sdk.NewCoin("uanc", sdkmath.NewInt(100000))
	...
	delegatePoolAddr := helper.App.AccountKeeper.GetModuleAddress(types.DelegatePoolModuleName)
	poolBalanceBefore := helper.App.BankKeeper.GetBalance(ctx, delegatePoolAddr, "uanc")
	...
	userBalanceAfter := helper.App.BankKeeper.GetBalance(ctx, delegatorAddr, "uanc")
	...
	poolBalanceAfter := helper.App.BankKeeper.GetBalance(ctx, delegatePoolAddr, "uanc")
	...
	userBalanceFinal := helper.App.BankKeeper.GetBalance(ctx, delegatorAddr, "uanc")
	...
	poolBalanceFinal := helper.App.BankKeeper.GetBalance(ctx, delegatePoolAddr, "uanc")
...
func TestLockFunds_WrappedCreateValidator(t *testing.T) {
	...
	amount := sdk.NewCoin("uanc", sdkmath.NewInt(1000000))
	...
	initialBalance := helper.App.BankKeeper.GetBalance(ctx, validatorAccAddr, "uanc")
	...
	validatorBalanceAfter := helper.App.BankKeeper.GetBalance(ctx, validatorAccAddr, "uanc")
	...
	validatorBalanceFinal := helper.App.BankKeeper.GetBalance(ctx, validatorAccAddr, "uanc")
...
func TestLockFunds_UnsupportedMessageType(t *testing.T) {
	...
	// Get initial balances
	initialUserBalance := helper.App.BankKeeper.GetBalance(ctx, delegatorAddr, "uanc")
	delegatePoolAddr := helper.App.AccountKeeper.GetModuleAddress(types.DelegatePoolModuleName)
	initialPoolBalance := helper.App.BankKeeper.GetBalance(ctx, delegatePoolAddr, "uanc")
...
func TestLockFundsError_InsufficientBalance(t *testing.T) {
	...
	currentBalance := helper.App.BankKeeper.GetBalance(ctx, delegatorAddr, "uanc")
	excessiveAmount := sdk.NewCoin("uanc", currentBalance.Amount.Add(sdkmath.NewInt(1000000)))
...
func TestIntegrationLockUnlock_ValidationEnqueueLockAllSuccess(t *testing.T) {
	...
	delegatorAddr := helper.GenAccs[0].GetAddress()
	validatorAddr := sdk.ValAddress(delegatorAddr)
	amount := sdk.NewCoin("uanc", sdkmath.NewInt(50000000))
...
func TestIntegrationLockUnlock_ValidationFailMinimumAmount(t *testing.T) {
	...
	delegatorAddr := helper.GenAccs[0].GetAddress()
	validatorAddr := sdk.ValAddress(delegatorAddr)
	zeroAmount := sdk.NewCoin("uanc", sdkmath.NewInt(0))
