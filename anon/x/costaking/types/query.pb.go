...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "anon.costaking.v1.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "anon.costaking.v1.QueryParamsResponse")
	proto.RegisterType((*QueryCostakerRewardsTrackerRequest)(nil), "anon.costaking.v1.QueryCostakerRewardsTrackerRequest")
	proto.RegisterType((*QueryCostakerRewardsTrackerResponse)(nil), "anon.costaking.v1.QueryCostakerRewardsTrackerResponse")
	proto.RegisterType((*QueryCurrentRewardsRequest)(nil), "anon.costaking.v1.QueryCurrentRewardsRequest")
	proto.RegisterType((*QueryCurrentRewardsResponse)(nil), "anon.costaking.v1.QueryCurrentRewardsResponse")
	proto.RegisterType((*QueryHistoricalRewardsRequest)(nil), "anon.costaking.v1.QueryHistoricalRewardsRequest")
	proto.RegisterType((*QueryHistoricalRewardsResponse)(nil), "anon.costaking.v1.QueryHistoricalRewardsResponse")
}

func init() { proto.RegisterFile("anon/costaking/v1/query.proto", fileDescriptor_7e71aa2f7fa447c3) }
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/anon.costaking.v1.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) CostakerRewardsTracker(ctx context.Context, in *QueryCostakerRewardsTrackerRequest, opts ...grpc.CallOption) (*QueryCostakerRewardsTrackerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/anon.costaking.v1.Query/CostakerRewardsTracker", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) HistoricalRewards(ctx context.Context, in *QueryHistoricalRewardsRequest, opts ...grpc.CallOption) (*QueryHistoricalRewardsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/anon.costaking.v1.Query/HistoricalRewards", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) CurrentRewards(ctx context.Context, in *QueryCurrentRewardsRequest, opts ...grpc.CallOption) (*QueryCurrentRewardsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/anon.costaking.v1.Query/CurrentRewards", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anon.costaking.v1.Query/Params",
	}
...
func _Query_CostakerRewardsTracker_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anon.costaking.v1.Query/CostakerRewardsTracker",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_HistoricalRewards_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anon.costaking.v1.Query/HistoricalRewards",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_CurrentRewards_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/anon.costaking.v1.Query/CurrentRewards",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "anon.costaking.v1.Query",
	...
	Metadata: "anon/costaking/v1/query.proto",
}
