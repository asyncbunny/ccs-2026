...
func TestGenesisValidate(t *testing.T) {
	...
	validCoins := sdk.NewCoins(sdk.NewCoin("uanc", math.NewInt(1000)))
	...
	tests := []struct {
		...
		},
		{
			...
			genesis: types.GenesisState{
				...
				CurrentRewards: types.CurrentRewardsEntry{
					Rewards: &types.CurrentRewards{
						Rewards:    sdk.Coins{sdk.Coin{Denom: "uanc", Amount: math.NewInt(-100)}},
						Period:     1,
						TotalScore: validScore,
					},
				},
	...
	tests := []struct {
		...
		},
		{
			...
			entry: types.HistoricalRewardsEntry{
				Period: 1,
				Rewards: &types.HistoricalRewards{
					CumulativeRewardsPerScore: sdk.Coins{sdk.Coin{Denom: "uanc", Amount: math.NewInt(-100)}},
				},
			},
			expErr: true,
		},
