...
import (
	...
	costakingtypes "github.com/anon-org/anon/v4/x/costaking/types"
)

// QueryCostaking queries the Costaking module of the Anon node according to the given function
