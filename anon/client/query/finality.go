...
// QueryFinality queries the Finality module of the Anon node according to the given function
...
// VotesAtHeight queries the Finality module to get signature set at a given anon block height
