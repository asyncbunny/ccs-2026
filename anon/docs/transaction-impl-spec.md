...
Bitcoin Staking script without a Anon chain operating.
...
[latest testnet docs](https://github.com/anon-org/networks/tree/main/anc-test-6/).
...
The Anon staking library exposes the [BuildV0IdentifiableStakingOutputsAndTx](../btcstaking/identifiable_staking.go?plain=1#L231)
...
The Anon Bitcoin staking library exposes
...
```go
import (
	// Anon btc staking library
	"github.com/anon-org/anon/btcstaking"
)
