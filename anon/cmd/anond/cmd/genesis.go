...
Example:
	anond prepare-genesis testnet anon-test-1
`,
...
func TestnetGenesisParams(
	...
	genParams.NativeCoinMetadatas = []banktypes.Metadata{
		{
			Description: "The native token of Anon",
			DenomUnits: []*banktypes.DenomUnit{
				...
				},
				{
					...
					Exponent: appparams.AncExponent,
					Aliases:  nil,
				},
			},
	...
	baseBtcHeader, err := anc.NewBTCHeaderBytesFromHex(baseBtcHeaderHex)
	if err != nil {
		panic(err)
	}
	...
	covenantPKsBIP340 := make([]anc.BIP340PubKey, 0, len(covenantPKs))
