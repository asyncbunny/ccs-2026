...
`,
		Example: `anond gen-helpers set-finality-providers path/to/finality_providers.json
	...
	"finality_providers": [
		{
			...
			"pop": {
				"btc_sig_type": "BIP340",
				"anon_sig": "/RJyVqBEm/PDkQQTDgdPj84MywTu6LUVXDWUlPBgDGo1qsU/Rg+kJhBRwxCEKs8PYmoADcp4FiH2vVyAqRG2UA==",
				"btc_sig": "OaLj+w2loH0O88cT2IEdUoV4Swx+RWagk632+mKs5wVRBM63D6uwW+lCLIjxVBfOYQRFzT2D9943k10Whw5a7Q=="
			},
			"slashed_anon_height": "0",
