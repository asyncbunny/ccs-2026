...
`,
		Example: `anond gen-helpers set-btc-delegations path/to/btc_delegations.json
	...
	"btc_delegations": [
		{
			...
			"pop": {
				"btc_sig_type": "BIP340",
				"anon_sig": "gjqXTQdgzC6AX/lnj3T3QV5vV+jtKDKwJOP9jMpZdb90MoIKRGV7j/A6lwbgsnUzbsvd4L19U7/3cOZqYBfQAg==",
