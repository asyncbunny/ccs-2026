...
import (
	...
	btcstypes "github.com/anon-org/anon/v4/x/btcstaking/types"
...
func addGenesisFlags(cmd *cobra.Command) {
	...
	cmd.Flags().String(flagCheckpointTag, btcctypes.DefaultCheckpointTag, "Hex encoded tag for anon checkpoint on btc")
	// epoch args
	...
	cmd.Flags().String(flagAllowedReporterAddresses, strings.Join(btcltypes.DefaultParams().InsertHeadersAllowList, ","), "addresses of reporters allowed to submit Bitcoin headers to anon")
	...
	// blocks args
	cmd.Flags().Int64(flagBlockGasLimit, anonApp.DefaultGasLimit, "Block gas limit")
	cmd.Flags().Int64(flagVoteExtensionEnableHeight, anonApp.DefaultVoteExtensionsEnableHeight, "Vote extension enable height")
	...
	// finality flags
	cmd.Flags().Uint64(flagActivationHeight, ftypes.DefaultFinalityActivationHeight, "Finality anc block height activation to start accepting finality vote and pub rand")
}
