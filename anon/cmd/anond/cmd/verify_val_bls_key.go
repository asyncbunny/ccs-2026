...
Example:
$ anond verify-validator-bls-key anonvaloper1...
$ anond verify-validator-bls-key anonvaloper1... --bls-password-file=/path/to/password.txt
$ anond verify-validator-bls-key anonvaloper1... --no-bls-password
`),
