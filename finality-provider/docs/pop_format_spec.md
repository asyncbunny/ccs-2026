...
- `BabyPublicKey` – The Anon secp256k1 public key in base64 format.
- `BabyAddress` – The Anon account address (`anc` prefix). The address is
...
- `BabySignEotsPk` – A signature of the `EotsPublicKey`, created by the Anon
...
which can be found [here](https://github.com/anon-org/finality-provider/blob/cc07bcd4dc434f7095668724aad6865bffe425e0/eotsmanager/cmd/eotsd/daemon/pop.go#L211).
