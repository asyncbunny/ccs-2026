...
// IsCSN mocks base method.
func (m *MockConsumerController) IsCSN() bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IsCSN")
	ret0, _ := ret[0].(bool)
	return ret0
}

// IsCSN indicates an expected call of IsCSN.
func (mr *MockConsumerControllerMockRecorder) IsCSN() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsCSN", reflect.TypeOf((*MockConsumerController)(nil).IsCSN))
}
...
func (m *MockConsumerController) QueryLastPubRandCommit(ctx context.Context, fpPk *btcec.PublicKey) (types0.PubRandCommit, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "QueryLastPubRandCommit", ctx, fpPk)
	ret0, _ := ret[0].(types0.PubRandCommit)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// QueryLastPubRandCommit indicates an expected call of QueryLastPubRandCommit.
func (mr *MockConsumerControllerMockRecorder) QueryLastPubRandCommit(ctx, fpPk any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "QueryLastPubRandCommit", reflect.TypeOf((*MockConsumerController)(nil).QueryLastPubRandCommit), ctx, fpPk)
}
...
// QueryPubRandCommitList mocks base method.
func (m *MockConsumerController) QueryPubRandCommitList(ctx context.Context, fpPk *btcec.PublicKey, startHeight uint64) ([]types0.PubRandCommit, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "QueryPubRandCommitList", ctx, fpPk, startHeight)
	ret0, _ := ret[0].([]types0.PubRandCommit)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// QueryPubRandCommitList indicates an expected call of QueryPubRandCommitList.
func (mr *MockConsumerControllerMockRecorder) QueryPubRandCommitList(ctx, fpPk, startHeight any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "QueryPubRandCommitList", reflect.TypeOf((*MockConsumerController)(nil).QueryPubRandCommitList), ctx, fpPk, startHeight)
}
...
// QueryLastPubRandCommit mocks base method.
func (m *MockRandomnessCommitter) QueryLastPubRandCommit(ctx context.Context, fpPk *btcec.PublicKey) (types0.PubRandCommit, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "QueryLastPubRandCommit", ctx, fpPk)
	ret0, _ := ret[0].(types0.PubRandCommit)
	ret1, _ := ret[1].(error)
...
// QueryLastPubRandCommit indicates an expected call of QueryLastPubRandCommit.
func (mr *MockRandomnessCommitterMockRecorder) QueryLastPubRandCommit(ctx, fpPk any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "QueryLastPubRandCommit", reflect.TypeOf((*MockRandomnessCommitter)(nil).QueryLastPubRandCommit), ctx, fpPk)
}

// QueryPubRandCommitList mocks base method.
func (m *MockRandomnessCommitter) QueryPubRandCommitList(ctx context.Context, fpPk *btcec.PublicKey, startHeight uint64) ([]types0.PubRandCommit, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "QueryPubRandCommitList", ctx, fpPk, startHeight)
	ret0, _ := ret[0].([]types0.PubRandCommit)
	ret1, _ := ret[1].(error)
...
// QueryPubRandCommitList indicates an expected call of QueryPubRandCommitList.
func (mr *MockRandomnessCommitterMockRecorder) QueryPubRandCommitList(ctx, fpPk, startHeight any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "QueryPubRandCommitList", reflect.TypeOf((*MockRandomnessCommitter)(nil).QueryPubRandCommitList), ctx, fpPk, startHeight)
}
